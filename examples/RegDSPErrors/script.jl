...
p1 = histogram(βpost[1,:], title = "posterior "*L"\beta_0", color = cols[7],
    ylabel = "posterior density", normalize = true)
vline!([βvect[1]], color = :black, linestyle = :dash, label = "true", lw = 2)
p2 = histogram(βpost[2,:], title = "posterior "*L"\beta_1", color = cols[7], 
    ylabel = "posterior density", normalize = true)
vline!([βvect[2]], color = :black, linestyle = :dash, label = "true", lw = 2)
p3 = histogram(μpost[:], title = "posterior "*L"\mu", color = cols[7], 
    ylabel = "posterior density", normalize = true)
vline!([μ], color = :black, linestyle = :dash, label = "true", lw = 2)
p4 = histogram(ϕpost[:], title = "posterior "*L"\phi", color = cols[7], 
ylabel = "posterior density", normalize = true)
